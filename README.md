...
**GDD Structure:**
- **Executive Summary:**
  - An unknown beam shot from the heart of Andromeda turned the seas to blood and made the buildings of man spiral downward into the Earth. Air on the surface is no longer livable, owing to the blood-red bloom of a xenoalgae that's aggressively colonized the oceans and turned the rains acidic, off-gassing carbon monoxide and xenon. After two centuries under these conditions, a new sort of society has emerged in the living bowels of the Earth. 
...
All UI elements should be minimal. If they are present, they should evoke medical imaging visuals.
